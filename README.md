...
- **[MarsNMe](https://github.com/Marsmanleo/MarsNMe)** - Agent-agnostic persistent memory backend. 13 MCP tools, Supabase + Jina embeddings, multi-profile isolation, semantic recall across sessions. `npx @marsnme/mcp-gateway`
